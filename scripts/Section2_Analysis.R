...
df_models_avg <- read.csv("df_models_avg_03May2024.csv")
...
names(df_models_avg)[13]<-'Position_in_range'
names(df_models_avg)[14]<-'Binary_change'
names(df_models_max)[13]<-'Position_in_range'
names(df_models_max)[14]<-'Binary_change'
...
df_models_avg <-  subset(df_models_both[,c(1:2,15,4:13,22)])
names(df_models_avg)[3]<-'Slope_value'
names(df_models_avg)[8]<-'BioRealm'
names(df_models_avg)[9]<-'Elevation'
names(df_models_avg)[10]<-'Troph'
names(df_models_avg)[11]<-'Length'
names(df_models_avg)[12]<-'Range'
names(df_models_avg)[13]<-'Position_in_range'
names(df_models_avg)[14]<-'Binary_change'
...
plot_avgdist_110<-ggplot(df_a10, aes(Position_in_range,fill = Binary_change, alpha=0.8)) +
  geom_density(adjust = 1/5,linewidth =0 ) +
  scale_fill_manual(values=c("blue", "red")) +
  scale_y_continuous(labels = number_format(accuracy = 0.01)) +
  theme_classic() + theme(legend.position="none")
plot_avgdist_110

plot_avgdist_120<-ggplot(df_a20, aes(Position_in_range,fill = Binary_change, alpha=0.8)) +
  geom_density(adjust = 1/5,linewidth =0 ) +
  scale_fill_manual(values=c("blue", "red")) +
  scale_y_continuous(labels = number_format(accuracy = 0.01)) +
  theme_classic() + theme(legend.position="none")
...
plot_avgdist_130<-ggplot(df_a30, aes(Position_in_range,fill = Binary_change, alpha=0.8)) +
  geom_density(adjust = 1/5,linewidth =0 ) +
  scale_fill_manual(values=c("blue", "red")) +
  scale_y_continuous(labels = number_format(accuracy = 0.01)) +
  theme_classic() + theme(legend.position="none")
...
plot_maxdist_110<-ggplot(df_m10, aes(Position_in_range,fill = Binary_change, alpha=0.8)) +
  geom_density(adjust = 1/5,linewidth =0 ) +
  scale_y_continuous(labels = number_format(accuracy = 0.01)) +
  scale_fill_manual(values=c("blue", "red")) +  effect_theme +
  theme(legend.position="none")
plot_maxdist_110

plot_maxdist_120<-ggplot(df_m20, aes(Position_in_range,fill = Binary_change, alpha=0.8)) +
  geom_density(adjust = 1/5,linewidth =0 ) +
  scale_y_continuous(labels = number_format(accuracy = 0.01)) +
  scale_fill_manual(values=c("blue", "red")) +  effect_theme +
  theme(legend.position="none")
...
plot_maxdist_130<-ggplot(df_m30, aes(Position_in_range,fill = Binary_change, alpha=0.8)) +
  geom_density(adjust = 1/5,linewidth =0 ) +
  scale_y_continuous(labels = number_format(accuracy = 0.01)) +
  scale_fill_manual(values=c("blue", "red")) +  effect_theme +
  theme(legend.position="none")
