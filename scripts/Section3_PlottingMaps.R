...
latitude_df_max <- df_models_avg$Latitude
longitude_df_max <- df_models_avg$Longitude

hex_map <- ggplot(df_models_avg, aes(x=longitude_df_max, y=latitude_df_max))+
...
order_data <- left_join(df_models_avg, order_data, by=c("Species"))
